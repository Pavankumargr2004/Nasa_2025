  ...
  return (
    <section className="flex flex-col items-center h-full justify-center p-2 sm:p-4 animate-fade-in">
      <div className="text-center mb-12">
        <h2 className="font-orbitron text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-300 to-orange-300 mb-4">
          Your Achievements
        </h2>
        <p className="text-lg text-violet-200 max-w-3xl mx-auto">
          Celebrate your cosmic journey! Here are the milestones you've reached so far.
        </p>
      </div>
        ...
        {allAchievements.map(ach => {
          ...
          return (
            ...
            >
              ...
              <h3 className={`font-orbitron text-xl font-bold mb-2 ${isUnlocked ? 'text-yellow-200' : 'text-violet-200'}`}>{ach.title}</h3>
